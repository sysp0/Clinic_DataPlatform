...
ابزار **Apache Airflow** هر ساعت داده‌ها را از دیتابیس عملیاتی می‌خواند، با **Pandera** اعتبارسنجی می‌کند و در Warehouse جایگزین  می‌کند (**SCD Type 1**).
...
| Airflow  | http://localhost:8080 | airflow / in docker |
